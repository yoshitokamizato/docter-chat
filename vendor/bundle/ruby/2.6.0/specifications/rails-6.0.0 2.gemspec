...
>>>>>>> 72bb5b7bd440f7a59b53c5ec5f98a88d2c9d0eb7
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 6.0.0"])
      ...
      s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 6.0.0"])
      s.add_runtime_dependency(%q<actiontext>.freeze, ["= 6.0.0"])
      ...
      s.add_dependency(%q<actionmailer>.freeze, ["= 6.0.0"])
      s.add_dependency(%q<activejob>.freeze, ["= 6.0.0"])
      s.add_dependency(%q<actioncable>.freeze, ["= 6.0.0"])
      s.add_dependency(%q<activestorage>.freeze, ["= 6.0.0"])
      s.add_dependency(%q<actionmailbox>.freeze, ["= 6.0.0"])
      s.add_dependency(%q<actiontext>.freeze, ["= 6.0.0"])
